export default ( jobs ) => {
    ...
    return jobs.map(( job ) => {
        ...
        return `
            <a class="nums jobs__post -block anim anim--tr js-lazy-anim js-gtm-event" data-ec="site interaction" data-ea="careers" data-el="${job.title}" href="/careers/?career=${job.id}">
