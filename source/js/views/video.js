export default ( blockJson, contentJson ) => {
    ...
    return `
        <div class="embed js-embed">
            ...
            <div class="embed__poster embed__overlay js-embed-poster js-lazy-image -cover -text--center" data-img-src="${contentJson.assetUrl}" data-variants="${contentJson.systemDataVariants}">
